...
$sql = "SELECT `product_id` as id,`product_name` as name,`product_price` as price,`product_gender` as gender,`product_brand` as brand,`product_img` as imageURL,`product_description` as description FROM `tbl_product` where `product_brand`='$brand'" ;
